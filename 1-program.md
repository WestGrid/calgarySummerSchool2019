...
| Tue **28th** morning 9:00am-12:00pm | [Introduction to HPC (part 1)](introHPC) by Alex Razoumov {{beg}} | [Introduction to C (and pointers) for Python Programmers](abstract-c-for-python) by Dmitri Rozmanov {{beg}} | [Application of Data Science to Finance](atb_1) by ATB Financial {{beg}} {{int}} |
| Tue **28th** afternoon 1:00pm-4:00pm | [Introduction to HPC (part 2)](introHPC) by Alex Razoumov {{beg}} | | [Gathering and Using Unstructured Data](atb_2) by ATB Financial {{beg}} {{int}} |
